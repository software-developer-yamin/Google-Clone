...
function Footer() {
     return (
          <footer className="grid w-full divide-y-[1px] text-sm divide-gray-300 bg-gray-100 mt-8">
               <div className='px-8 py-3'>
                    <p>Bangladesh</p>
               </div>
               <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 grid-flow-row-dense px-8 py-3'>
                    <div className='flex justify-center items-center md:col-span-2 lg:col-span-1 md:col-start-2'>
